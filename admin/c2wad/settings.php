...
if (isset($_POST['set'])) {
  ...
  $scy = $_POST['cy'];
  $currency = 'USD'; // Replace with your desired default currency value
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if ($logo != "") {
      $sql = "INSERT INTO settings (sname, wl, rb, bname, email, phone, title, logo, cy, currency) VALUES ('$sname','$wl','$rb','$bname','$email','$phone','$title','$logo','$scy','$currency')";
    } else {
      $sql = "INSERT INTO settings (sname, wl, rb, bname,  email, phone, title, cy,currency) VALUES ('$sname','$wl','$rb','$bname','$email','$phone','$title','$scy','$currency')";
    }
...
if (isset($_POST['uset'])) {
  ...
  if ($logo != "") {
    $sql = "UPDATE settings SET  sname='$sname', wl='$wl', rb='$rb',   bname='$bname', email='$email', phone='$phone', title='$title', logo='$logo', cy='$scy' WHERE id = '$ids' ";
  } else {
    $sql = "UPDATE settings SET  sname='$sname', wl='$wl', rb='$rb',   bname='$bname', email='$email', phone='$phone', title='$title', cy='$scy' WHERE id = '$ids' ";
  }
