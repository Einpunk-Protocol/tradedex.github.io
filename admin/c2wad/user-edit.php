...
if (isset($_POST['edit'])) {
  ...
  if (!empty($_POST['refbonus']) && is_numeric($_POST['refbonus'])) {
    $refbonus = $link->real_escape_string($_POST['refbonus']);
  } else {
    $msg = "Invalid 'refbonus' value. Please enter a valid decimal number.";
    // You might want to handle the error further or return an error message to the user.
  }
