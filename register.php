<?php
require "config/register_logic.php"
                    ...
                    <div>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="fname" id="fname" placeholder="First Name" type="text" pattern="[A-Za-z ]+" minlength="1" maxlength="50" title="Input your firstname using letters (UPPERCASE or lowercase) only." required>
                                <span class="help-block"><?php echo $fname_err; ?></span>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="lname" id="lname" placeholder="Last Name" type="text" pattern="[A-Za-z ]+" minlength="1" maxlength="50" title="Input your firstname using letters (UPPERCASE or lowercase) only." required>
                                <span class="help-block"><?php echo $lname_err; ?></span>
                            </div>
                            <div class="form-group">
                                <input class="form-control" name="username" id="username" placeholder="Username" type="text" pattern="[A-Za-z0-9@#&_-+ ]+" minlength="5" maxlength="50" title="Input a username using letters (UPPERCASE or lowercase) and numbers only." required>
                                <span class="help-block"><?php echo $username_err; ?></span>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="email" id="email" placeholder="Email address" type="email" pattern="[A-Za-z0-9.-_@]+" minlength="5" maxlength="50" required>
                                <span class="help-block"><?php echo $email_err; ?></span>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="phone" id="phone" placeholder="phone" type="text" required>
                                <span class="help-block"><?php echo $phone_err; ?></span>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="password" id="password" placeholder="Password" type="password" minlength="7" maxlength="15" required>
                                <span class="help-block"><?php echo $password_err; ?></span>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="cpassword" id="cpassword" placeholder="Confirm password" type="password" minlength="7" maxlength="15" required>
