                            ...
                            <div class="card">
                                <div class="content">
                                    ...
                                    <p style="text-align: center;">
                                        <b>Perfect Money Payment Process</b>
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" id="myInputs" readonly>
                                        ...
                                        <form action="" method="post">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Value in PM is displayed here</label>
                                                    <input type="double" id="pm" name="pm" class="form-control" placeholder="Value in BTC is displayed here" readonly>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="double" onchange="btcconverter(this);" onkeyup="btcconverter(this);" id="usd" name="usd" placeholder="Amount in USD" class="form-control" required>

                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Paste the transferred PM transaction ID</label>
